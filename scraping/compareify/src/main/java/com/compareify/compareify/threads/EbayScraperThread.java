...
public class EbayScraperThread implements Runnable {
    ...
    public EbayScraperThread() {
    }

    public EbayScraperThread(String target_url, String target_path, int items_per_page, String[] targeted_products) {
    ...
    public void run() {
        ...
        EbayScraper ebayScraper = new EbayScraper(target_url, target_path, items_per_page);

        for (String targetedProduct : targeted_products) {
            scraped_products = ebayScraper.scrape(targetedProduct);
